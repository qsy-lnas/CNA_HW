...
public class AuthSender {
	public static void main(String[] args) throws Exception {
		...
		String username = "dtt19@mails.tsinghua.edu.cn";
		...
		command = "MAIL FROM:<dtt19@mails.tsinghua.edu.cn>\r\n";
		System.out.print(command);
		os.write(command.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
		...
		command = "RCPT TO:<714398500@qq.com>\r\n";
		System.out.print(command);
		os.write(command.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
		...
		str = "From:" + "dtt19@mails.tsinghua.edu.cn" + "\r\n";
		System.out.print(str);
		os.write(str.getBytes("US-ASCII"));
		// TODO: 16.把"x@x.x"改为邮件中显示的收件人地址
		str = "To:" + "714398500@qq.com" + "\r\n";
		System.out.print(str);
		os.write(str.getBytes("US-ASCII"));

		/** 发送邮件內容. */
		// TODO: 17.在"x"中填入Subject内容.
		str = "SUBJECT:" + "hello java" + "\r\n\r\n";
		System.out.print(str);
		os.write(str.getBytes("US-ASCII"));
		// TODO: 18.在"x"中填入邮件正文内容.
		str = "java-vesion chiningmeng" + "\r\n";
		System.out.print(str);
		os.write(str.getBytes("US-ASCII"));
